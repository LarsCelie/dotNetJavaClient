 ...
 * 
 */
@WebServiceClient(name = "CustomerService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8733/Design_Time_Addresses/ServiceLibrary/Service2/?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8733/Design_Time_Addresses/ServiceLibrary/Service2/?wsdl");
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_ICustomerService")
    public ICustomerService getBasicHttpBindingICustomerService() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_ICustomerService"), ICustomerService.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_ICustomerService")
    public ICustomerService getBasicHttpBindingICustomerService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_ICustomerService"), ICustomerService.class, features);
    }
