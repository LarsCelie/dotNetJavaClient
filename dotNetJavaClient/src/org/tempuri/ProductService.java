 ...
 * 
 */
@WebServiceClient(name = "ProductService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8733/Design_Time_Addresses/ServiceLibrary/Service1/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICE_QNAME = new QName("http://tempuri.org/", "ProductService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8733/Design_Time_Addresses/ServiceLibrary/Service1/?wsdl");
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_IProductService")
    public IProductService getBasicHttpBindingIProductService() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_IProductService"), IProductService.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_IProductService")
    public IProductService getBasicHttpBindingIProductService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_IProductService"), IProductService.class, features);
    }
